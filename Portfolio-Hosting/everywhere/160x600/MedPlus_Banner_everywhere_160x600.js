...
lib.ssMetadata = [
		{name:"MedPlus_Banner_everywhere_160x600_atlas_", frames: [[0,402,600,400],[0,0,600,400]]}
];
...
(lib.Humanitarian1 = function() {
	this.spriteSheet = ss["MedPlus_Banner_everywhere_160x600_atlas_"];
	this.gotoAndStop(0);
...
(lib.txtline1e = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(107.9,13.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgnA1IAAhpIBOAAIAAAVIg3AAIAAAWIAwAAIAAATIgwAAIAAAWIA4AAIAAAVg");
	this.shape_1.setTransform(100,9.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AATA1IgWgiIgTAAIAAAiIgWAAIAAhpIAuAAQAIAAALAEQAHACAFAFQAEAEADAHQACAGAAAHIAAAAQAAAGgCAGQgBAFgDADIgHAHQgEADgFACIAaAmgAgWAAIAXAAIAIgBQADgBACgDQADgCABgCQABgDAAgEQAAgEgBgCQgBgDgDgCQgCgCgEAAIgHgBIgXAAg");
	this.shape_2.setTransform(88.9,9.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgnA1IAAhpIBOAAIAAAVIg3AAIAAAWIAxAAIAAATIgxAAIAAAWIA4AAIAAAVg");
	this.shape_3.setTransform(77.4,9.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAWA1IAAgrIgqAAIAAArIgYAAIAAhpIAYAAIAAAqIAqAAIAAgqIAWAAIAABpg");
	this.shape_4.setTransform(65.5,9.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAYA1IgYhEIgXBEIgUAAIgkhpIAZAAIAWBGIAXhGIATAAIAYBGIAVhGIAZAAIgkBpg");
	this.shape_5.setTransform(50.5,9.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgLA1IAAgqIgog/IAbAAIAYArIAagrIAaAAIgoA+IAAArg");
	this.shape_6.setTransform(35.9,9.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AATA1IgWgiIgTAAIAAAiIgWAAIAAhpIAuAAQAIAAAKAEQAIACAFAFQAEAEADAHQACAGAAAHIAAAAQAAAGgCAGQgBAFgDADIgHAHQgEADgGACIAbAmgAgWAAIAXAAIAIgBQADgBACgDQADgCABgCQABgDAAgEQAAgEgBgCQgBgDgDgCQgDgCgDAAIgHgBIgXAAg");
	this.shape_7.setTransform(24.6,9.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgnA1IAAhpIBOAAIAAAVIg3AAIAAAWIAxAAIAAATIgxAAIAAAWIA4AAIAAAVg");
	this.shape_8.setTransform(13.1,9.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgJA1IgrhpIAaAAIAaBJIAchJIAZAAIgrBpg");
	this.shape_9.setTransform(1.3,9.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgnA1IAAhpIBPAAIAAAVIg4AAIAAAWIAwAAIAAATIgwAAIAAAWIA4AAIAAAVg");
	this.shape_10.setTransform(-10,9.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.txtline1e, new cjs.Rectangle(-17.2,0.8,130.3,19), null);
...
(lib.txtline1d = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgLAMIAAgXIAXAAIAAAXg");
	this.shape.setTransform(103,15.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgKA0IAAhSIghAAIAAgWIBWAAIAAAWIggAAIAABSg");
	this.shape_1.setTransform(96,11.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(85.6,11.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(73.8,11.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAeA0IAAhDIgeAsIAAAAIgdgrIAABCIgWAAIAAhoIAYAAIAbAtIAbgtIAZAAIAABog");
	this.shape_4.setTransform(60.2,11.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgnA0IAAhoIBPAAIAAAVIg4AAIAAAVIAxAAIAAAUIgxAAIAAAWIA4AAIAAAUg");
	this.shape_5.setTransform(43,11.5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAVA0IAAgqIgqAAIAAAqIgWAAIAAhoIAWAAIAAAqIAqAAIAAgqIAYAAIAABog");
	this.shape_6.setTransform(31.4,11.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgKA0IAAhSIghAAIAAgWIBXAAIAAAWIghAAIAABSg");
	this.shape_7.setTransform(20.1,11.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.txtline1d, new cjs.Rectangle(13.3,2.8,94.8,19), null);
...
(lib.txtline1c = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgwA1IAAhoIApAAIALAAIALADIAKAGIAIAGIAGAHIAFAJIADAKIABAKIAAAAIgBALQgBAFgCAFQgCAEgDAEIgGAJIgIAGIgKAEIgLADIgLACgAgZAfIASAAQAHAAAFgCQAGgCAFgEQAEgFACgFQACgGAAgGIAAgBQAAgGgCgGQgCgGgEgEQgFgEgGgDQgFgCgHAAIgSAAg");
	this.shape.setTransform(107.9,13.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgnA1IAAhoIBOAAIAAAUIg3AAIAAAWIAwAAIAAATIgwAAIAAAWIA4AAIAAAVg");
	this.shape_1.setTransform(96.2,13.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgvA1IAAhoIApAAIALAAIAKADIAJAGIAJAGIAHAHIAEAJIAEAKIABAKIAAAAIgBALQgBAFgDAFQgBAEgDAEIgHAJIgJAGIgJAEIgKADIgLACgAgYAfIASAAQAGAAAFgCQAGgCAEgEQAEgFADgFQACgGAAgGIAAgBQAAgGgCgGQgDgGgEgEQgEgEgGgDQgFgCgGAAIgSAAg");
	this.shape_2.setTransform(84.5,13.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgnA1IAAhoIBPAAIAAAUIg4AAIAAAWIAwAAIAAATIgwAAIAAAWIA4AAIAAAVg");
	this.shape_3.setTransform(72.8,13.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgnA1IAAhoIBOAAIAAAUIg3AAIAAAWIAwAAIAAATIgwAAIAAAWIA4AAIAAAVg");
	this.shape_4.setTransform(62,13.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAbA1IgyhCIAABCIgXAAIAAhoIAWAAIAwA/IAAg/IAXAAIAABog");
	this.shape_5.setTransform(50,13.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(33.1,13.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgNAYIADgvIAYAAIAAABIgPAug");
	this.shape_7.setTransform(26.1,10.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgKA1IAAhTIghAAIAAgVIBXAAIAAAVIghAAIAABTg");
	this.shape_8.setTransform(18.2,13.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgLA1IAAhoIAXAAIAABog");
	this.shape_9.setTransform(10,13.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.txtline1c, new cjs.Rectangle(5.5,4.5,111,19), null);
...
(lib.txtline1b = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgnA0IAAhnIBPAAIAAAUIg4AAIAAAVIAwAAIAAAUIgwAAIAAAWIA4AAIAAAUg");
	this.shape.setTransform(110.3,10);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AATA0IgWghIgTAAIAAAhIgWAAIAAhnIAuAAQAIAAAKACQAIADAFAFQAEAFADAFQACAHAAAHIAAABQAAAFgCAGQgBAFgDADIgHAHQgEADgFACIAaAlgAgWgBIAXAAIAIgBQADgBACgCQADgBABgEQABgCAAgDQAAgFgBgCQgBgDgDgCQgCgCgEgBIgHgBIgXAAg");
	this.shape_1.setTransform(99.2,10);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgnA0IAAhnIBOAAIAAAUIg3AAIAAAVIAxAAIAAAUIgxAAIAAAWIA4AAIAAAUg");
	this.shape_2.setTransform(87.8,10);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAWA0IAAgpIgrAAIAAApIgWAAIAAhnIAWAAIAAApIArAAIAAgpIAWAAIAABng");
	this.shape_3.setTransform(76.1,10);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAYA1IgYhDIgXBDIgUAAIgkhoIAZAAIAWBGIAXhHIATAAIAYBHIAVhGIAZAAIgkBog");
	this.shape_4.setTransform(61.2,10);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgnA0IAAhnIBPAAIAAAUIg4AAIAAAVIAwAAIAAAUIgwAAIAAAWIA4AAIAAAUg");
	this.shape_5.setTransform(41.9,10);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AATA0IgWghIgTAAIAAAhIgWAAIAAhnIAuAAQAIAAAKACQAIADAFAFQAEAFADAFQACAHAAAHIAAABQAAAFgCAGQgBAFgDADIgHAHQgEADgFACIAaAlgAgWgBIAXAAIAIgBQADgBACgCQADgBABgEQABgCAAgDQAAgFgBgCQgBgDgDgCQgDgCgDgBIgHgBIgXAAg");
	this.shape_6.setTransform(30.8,10);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAfA1IgJgYIgrAAIgKAYIgYAAIAthpIAVAAIAtBpgAAOAJIgOghIgNAhIAbAAg");
	this.shape_7.setTransform(18.3,10);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(6.2,10);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.txtline1b, new cjs.Rectangle(-1.5,1.3,119.6,19), null);
...
(lib.txtline1a = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AATA0IgWghIgTAAIAAAhIgWAAIAAhoIAuAAQAIABAKADQAIACAFAFQAFAEACAHQACAGAAAHIAAAAQAAAHgCAFQgBAFgDADIgHAHQgEADgGACIAbAlgAgWgBIAXAAIAIgBQADAAACgCQADgCABgEQABgCAAgEQAAgEgBgCQgBgDgDgCQgDgCgDAAIgHgBIgXAAg");
	this.shape.setTransform(112.4,7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgSAyIgIgDIgHgFIgFgHIgEgIIgCgJIgBgLIAAg7IAXAAIAAA6QAAAGACAFQABAFADAEQADADAEABQAFACAEAAQAFAAAEgBQAFgCADgDIAEgIQACgFAAgGIAAg7IAXAAIAAA6IgBALQgBAFgCAFIgDAIIgGAHIgGAFIgIADQgMADgHAAQgNgBgFgCg");
	this.shape_1.setTransform(100.4,7.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(87.9,7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgLA0IAAgpIgog/IAbAAIAYAqIAagqIAaAAIgoA+IAAAqg");
	this.shape_3.setTransform(75.7,7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgnA0IAAhoIBPAAIAAAVIg4AAIAAAVIAxAAIAAAUIgxAAIAAAWIA4AAIAAAUg");
	this.shape_4.setTransform(60,7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAUA0IgfgsIgNANIAAAfIgXAAIAAhoIAXAAIAAAvIAqgvIAcAAIgrAtIAtA7g");
	this.shape_5.setTransform(49.3,7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAfA1IgJgYIgrAAIgKAYIgYAAIAthpIAVAAIAtBpgAAOAJIgOghIgNAhIAbAAg");
	this.shape_6.setTransform(36.9,7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgKA0IAAhSIghAAIAAgWIBXAAIAAAWIghAAIAABSg");
	this.shape_7.setTransform(25.6,7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.txtline1a, new cjs.Rectangle(18.8,-1.7,101.3,19), null);
...
(lib.humanitarian2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.humanitarian2, new cjs.Rectangle(0,0,600,400), null);


(lib.humanitarian1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.humanitarian1, new cjs.Rectangle(0,0,600,400), null);
...
(lib.mainimg = function(mode,startPosition,loop) {
	...
	this.instance = new lib.humanitarian2();
	this.instance.parent = this;
	this.instance.setTransform(94.1,92.1,0.629,0.629,0,0,0,191.8,128.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:119.1},334,cjs.Ease.quadOut).wait(1));

	// everywhere-1
	this.instance_1 = new lib.humanitarian1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(93.1,92.1,0.629,0.629,0,0,0,191.7,128.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:129.1},334,cjs.Ease.quadOut).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-27.5,11.5,378.4,251.7);


// stage content:
(lib.MedPlus_Banner_everywhere_160x600 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(1).call(this.frame_1).wait(247).call(this.frame_248).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.bigBtn).wait(249));
	...
	this.timeline.addTween(cjs.Tween.get(this.cta).wait(238).to({scaleX:0.04,scaleY:0.04,y:530},0).to({scaleX:1,scaleY:1,y:527.5},10,cjs.Ease.backOut).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(198).to({_off:false},0).to({alpha:1},8).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(198).to({_off:false},0).to({alpha:1},8).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(198).to({_off:false},0).to({alpha:1},8).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(198).to({_off:false},0).to({alpha:1},8).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(198).to({_off:false},0).to({alpha:1},8).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(38).to({_off:false},0).to({alpha:1},8).wait(122).to({alpha:0},8).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(38).to({_off:false},0).to({alpha:1},8).wait(122).to({alpha:0},8).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(38).to({_off:false},0).to({alpha:1},8).wait(122).to({alpha:0},8).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(38).to({_off:false},0).to({alpha:1},8).wait(122).to({alpha:0},8).wait(73));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(93).to({_off:false},0).to({alpha:1},8).wait(67).to({alpha:0},8).wait(73));

	// cross-cover
	this.instance_11 = new lib.crosscover();
	this.instance_11.parent = this;
	this.instance_11.setTransform(-113,393.1,0.929,0.929,0,0,0,-20,354.8);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({regX:167.2,regY:167.6,scaleX:1.14,scaleY:1.14,x:61.1,y:219.3,alpha:1},5,cjs.Ease.sineOut).wait(244));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(5).to({graphics:mask_graphics_5,x:80,y:219.1}).wait(244));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(5).to({_off:false},0).wait(244));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(249));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/MedPlus_Banner_everywhere_160x600_atlas_.png?1506107493741", id:"MedPlus_Banner_everywhere_160x600_atlas_"}
	],
	preloads: []
};
